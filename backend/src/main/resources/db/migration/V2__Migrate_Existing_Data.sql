...
UPDATE asn_headers SET client_id = @default_client_id WHERE client_id IS NULL;
UPDATE asn_lines SET client_id = @default_client_id WHERE client_id IS NULL;
UPDATE processed_files SET client_id = @default_client_id WHERE client_id IS NULL;
UPDATE mapping_rules SET client_id = @default_client_id WHERE client_id IS NULL;
